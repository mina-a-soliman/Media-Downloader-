...
data class SubtitleStyle(
    ...
    companion object {
        ...
        private val FAMILY_OVERRIDES = mapOf(
            ...
            "NotoSansSC-Regular.otf" to "Noto Sans SC",
            "NotoSerifSC-Regular.otf" to "Noto Serif SC",
            "NotoSansTC-Regular.otf" to "Noto Sans TC",
            "NotoSerifTC-Regular.otf" to "Noto Serif TC",
            "NotoSansCJK-Regular.ttc" to "Noto Sans CJK",
            "NotoSansHK-Regular.otf" to "Noto Sans HK",
